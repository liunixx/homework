...
public class Tester {
    public static void main(String[] args) {
           ...
           TrainTickets trainTickets = new TrainTickets(totalTickets,roundTripTickets);
           if(trainTickets.checkOK()) {
               System.out.println("Total tickets: "+trainTickets.getTotalTickets());
               System.out.println("Round-trip: "+trainTickets.getRoundTripTickets());
               System.out.println("Total: "+trainTickets.getTotalPrice());
           }
    }
}
...
class TrainTickets{
    ...
    public TrainTickets(int total, int roundTrip) {
